...
const timelineData = [
  {
    ...
    endDate: "Present",
    description:
      "Lead development of enterprise-level desktop applications using C#. Web Application development using Wordpress, React, Node.js",
    achievements: ["Creating a POS system using C# from scratch"],
    technologies: ["Visual Studio", "C#", "SQL", "SQL Managment System"],
    icon: Briefcase,
  },
  {
    id: 2,
    ...
    achievements: [
      "Create and Design a Database for Procurement service in the Negombo Municipal Council",
      "Create and Design a Database for Walking Lane Reservation System in the Negombo Municipal Council",
      "Design Database for Photoshoot Reservationsystem in the Negombo Municipal Council",
    ],
  ...
  },
  {
    ...
    achievements: [
      ...
      "patched applications to stay up to date with the latest features",
  ...
  },
  {
    ...
    description:
      "Review on AI-driven methods for detecting and managing depression among university students, emphasizing early identification, confidentiality, and accessibility.",
    achievements: [
      "AI-based screening tools",
      "improving mental health support services within academic institutions",
    ],
    technologies: [],
    icon: Award,
  },
  {
    ...
    company: "Gampaha Wickramarchchi University of Indigeous Medicine (GWUIM)",
    location: "Kandy Road, Yakkala, Sri Lanka.",
    startDate: "2022 March",
    endDate: "Present",
    description:
      "Learning About OOP, Web Development, Data Structures and Algorithms, .ASP NET C#, MERN Stack, AI/ML, Health Information Mangment",
    achievements: [
      "Current GPA 3.90 Up to 3rd Year",
      "Former President of Technological Advancment Society",
    ],
    technologies: [
      "Java",
      "Python",
  ...
  },
  {
    ...
    endDate: "2024 Jan",
    description:
      " Web Design and Development Techniques and hone your ability to work with Graphics Designing for web applications with Web Engineering Technologies, Web Accessibility and Validation Techniques",
    achievements: ["Successfully Completed Course and Acquired Certificate"],
    technologies: ["Wordpress", "CSS", "JavaScript", "Photshop", "PHP", "HTML"],
    icon: GraduationCap,
  },

  {
    ...
    company: "Rahula Collage Matara",
    location: "Matara, Sri Lanka.",
    startDate: "2016 Jan",
    endDate: "2019 Aug",
    description: "G.C.E Advanced Level—Rahula College Matara - 2020",
    achievements: [
